// @ts-nocheck -- bpmn-js plugin pattern, uses prototype-based constructor
import { assign, forEach, isArray } from 'min-dash'
import { is } from 'bpmn-js/lib/util/ModelUtil'
import { isExpanded, isEventSubProcess } from 'bpmn-js/lib/util/DiUtil'
import { isAny } from 'bpmn-js/lib/features/modeling/util/ModelingUtil'
import { getChildLanes } from 'bpmn-js/lib/features/modeling/util/LaneUtil'
// Inlined from diagram-js/lib/util/Mouse to avoid pnpm transitive dependency issue
function hasPrimaryModifier(event: any): boolean {
  ...
  if (isAny(businessObject, ['bpmn:Lane', 'bpmn:Participant']) && isExpanded(businessObject)) {
    ...
    assign(actions, {
      'lane-insert-above': {
        ...
        action: {
          click: (event: any, element: any) => modeling.addLane(element, 'top')
        }
      }
    })
    ...
    assign(actions, {
      'lane-insert-below': {
        ...
        action: {
          click: (event: any, element: any) => modeling.addLane(element, 'bottom')
        }
      }
    })
  }
...
function isEventType(eventBo: any, type: string, definition: string): boolean {
